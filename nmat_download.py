...
Files: nmat_downloads/V<vol>I<iss>/<doi>.pdf
"""
...
DATA = json.loads((PROJECT/"nmat_dois.json").read_text(encoding="utf-8"))
DL = PROJECT/"nmat_downloads"; DL.mkdir(exist_ok=True)
CONC = 8
...
def main(budget):
    ...
    print(f"nmat 2018-2026: target={total}, on_disk={have0}, queue={len(work)}, conc={CONC}, budget={budget}s", flush=True)
    if not work:
